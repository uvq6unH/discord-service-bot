...
const groupMap = {
  ...
  lollink: 'lol',
  lolunlink: 'lol',
  // ΓöÇΓöÇ TFT ΓÇö grouped with LoL ΓöÇΓöÇ
  tftlsd: 'lol',
  tftprofile: 'lol',
  tftmatch: 'lol',
  tftlink: 'lol',
...
const groupMetadata = {
  general: {
    title: 'ΓÜÖ∩╕Å Lß╗çnh Chung & Custom',
    description: 'C├íc lß╗çnh c╞í bß║ún v├á lß╗çnh t├╣y chß╗ënh tr├¬n m├íy chß╗º.'
  },
  user: {
    title: '≡ƒæñ Th├ánh Vi├¬n & Cß║Ñp ─Éß╗Ö',
    description: 'C├íc lß╗çnh xem hß╗ô s╞í th├ánh vi├¬n, h├¼nh ─æß║íi diß╗çn v├á hß╗ç thß╗æng cß║Ñp ─æß╗Ö XP.'
  },
  server: {
    title: '≡ƒûÑ∩╕Å M├íy Chß╗º & Ph├ít Thanh',
    description: 'C├íc lß╗çnh hiß╗ân thß╗ï th├┤ng tin m├íy chß╗º, ph├ít th├┤ng b├ío v├á dß╗ìn dß║╣p.'
  },
  moderation: {
    title: '≡ƒ¢í∩╕Å Kiß╗âm Duyß╗çt & Bß║úo Mß║¡t',
    description: 'C├íc lß╗çnh xß╗¡ phß║ít th├ánh vi├¬n vi phß║ím (ban, kick, timeout, cß║únh c├ío).'
  },
  interactions: {
    title: '≡ƒöö T╞░╞íng T├íc & N├║t Bß║Ñm',
    description: 'C├íc lß╗çnh ─æ─âng bß║úng chß╗ìn vai tr├▓ tß╗▒ ─æß╗Öng v├á tß║ío k├¬nh hß╗ù trß╗ú (ticket).'
  },
  games: {
    title: '≡ƒÄ« Tr├▓ Ch╞íi',
    description: 'Blackjack, Poker, Coinflip, Dice v├á Slots ΓÇö ─æß║╖t c╞░ß╗úc bß║▒ng tiß╗ün ß║úo cß╗ºa server.'
  },
  lol: {
    title: 'ΓÜö∩╕Å League of Legends & TFT',
    description: 'Tra cß╗⌐u lß╗ïch sß╗¡ ─æß║Ñu LoL/TFT, hß╗ô s╞í ng╞░ß╗¥i ch╞íi, th├┤ng tin t╞░ß╗¢ng, trang bß╗ï, bß║úng ngß╗ìc v├á chi tiß║┐t trß║¡n TFT.'
  },
};
...
async function buildHelpPayload(client, config, guild, userId, selectedGroup = null) {
  ...
  const selectMenu = new StringSelectMenuBuilder()
    ...
    .setPlaceholder('Chß╗ìn danh mß╗Ñc c├óu lß╗çnh...')
    .addOptions(
      new StringSelectMenuOptionBuilder()
        .setLabel('Lß╗çnh Chung & Custom')
        .setValue('help_group:general')
        .setDescription('C├íc lß╗çnh c╞í bß║ún v├á lß╗çnh tß╗▒ tß║ío')
        .setEmoji('ΓÜÖ∩╕Å')
        .setDefault(selectedGroup === 'general'),
      new StringSelectMenuOptionBuilder()
        .setLabel('Th├ánh Vi├¬n & Cß║Ñp ─Éß╗Ö')
        .setValue('help_group:user')
        .setDescription('Xem th├┤ng tin, avatar v├á ─æiß╗âm XP')
        .setEmoji('≡ƒæñ')
        .setDefault(selectedGroup === 'user'),
      new StringSelectMenuOptionBuilder()
        .setLabel('M├íy Chß╗º & Ph├ít Thanh')
        .setValue('help_group:server')
        .setDescription('Th├┤ng tin server v├á ph├ít th├┤ng b├ío')
        .setEmoji('≡ƒûÑ∩╕Å')
        .setDefault(selectedGroup === 'server'),
      new StringSelectMenuOptionBuilder()
        .setLabel('Kiß╗âm Duyß╗çt')
        .setValue('help_group:moderation')
        .setDescription('C├íc lß╗çnh ban, kick, timeout bß║úo mß║¡t')
        .setEmoji('≡ƒ¢í∩╕Å')
        .setDefault(selectedGroup === 'moderation'),
      new StringSelectMenuOptionBuilder()
        .setLabel('T╞░╞íng T├íc & N├║t Bß║Ñm')
        .setValue('help_group:interactions')
        .setDescription('─É─âng bß║úng ticket hß╗ù trß╗ú v├á tß╗▒ chß╗ìn role')
        .setEmoji('≡ƒöö')
      ...
      new StringSelectMenuOptionBuilder()
        ...
        .setDescription('Tra cß╗⌐u ─æß║Ñu LoL/TFT, hß╗ô s╞í, t╞░ß╗¢ng, trang bß╗ï, bß║úng ngß╗ìc')
        .setEmoji('ΓÜö∩╕Å')
  ...
  if (!selectedGroup) {
    embed.setTitle(`H╞░ß╗¢ng Dß║½n Sß╗¡ Dß╗Ñng Bot - ${guild.name}`)
      .setDescription(
        `Ch├áo mß╗½ng bß║ín ─æß║┐n vß╗¢i bß║úng h╞░ß╗¢ng dß║½n! M├íy chß╗º ─æang sß╗¡ dß╗Ñng tiß╗ün tß╗æ l├á \`${prefix}\`.\n\n` +
        `Vui l├▓ng chß╗ìn mß╗Öt danh mß╗Ñc c├óu lß╗çnh tß╗½ tr├¼nh ─æ╞ín b├¬n d╞░ß╗¢i ─æß╗â xem chi tiß║┐t c├íc lß╗çnh.\n\n` +
        `**C├íc danh mß╗Ñc khß║ú dß╗Ñng:**\n` +
        `ΓÇó ΓÜÖ∩╕Å **Lß╗çnh Chung & Custom**: C├íc lß╗çnh c╞í bß║ún.\n` +
        `ΓÇó ≡ƒæñ **Th├ánh Vi├¬n & Cß║Ñp ─Éß╗Ö**: Thß║╗ th├┤ng tin, cß║Ñp ─æß╗Ö XP.\n` +
        `ΓÇó ≡ƒûÑ∩╕Å **M├íy Chß╗º & Ph├ít Thanh**: Th├┤ng tin server, gß╗¡i th├┤ng b├ío.\n` +
        `ΓÇó ≡ƒ¢í∩╕Å **Kiß╗âm Duyß╗çt**: Ban, kick, dß╗ìn tin nhß║»n.\n` +
        `ΓÇó ≡ƒöö **T╞░╞íng T├íc**: Tß╗▒ nhß║¡n vai tr├▓, k├¬nh Ticket.\n` +
        `ΓÇó ≡ƒÄ« **Tr├▓ Ch╞íi**: Blackjack, Poker, Coinflip, Dice, Slots.\n` +
        `ΓÇó ΓÜö∩╕Å **League of Legends**: Tra cß╗⌐u hß╗ô s╞í, t╞░ß╗¢ng, lß╗ïch sß╗¡ ─æß║Ñu.`
      )
      .setFooter({ text: 'Sß╗¡ dß╗Ñng select menu b├¬n d╞░ß╗¢i ─æß╗â duyß╗çt lß╗çnh' });
  } else {
    ...
    embed.setTitle(meta.title)
      .setDescription(meta.description + '\n\n' + (groupCommands.length ? '' : '*Kh├┤ng c├│ lß╗çnh n├áo ─æ╞░ß╗úc bß║¡t trong nh├│m n├áy.*'));
    ...
    for (const cmd of groupCommands) {
      ...
      embed.addFields({
        name: cmdDisplay,
        value: cmd.description || 'Kh├┤ng c├│ m├┤ tß║ú.',
        inline: false
      });
    }

    embed.setFooter({ text: `Danh mß╗Ñc: ${meta.title} | Tß╗òng sß╗æ: ${groupCommands.length} lß╗çnh` });
  }
...
function normalizeCurrency(value) {
  ...
  if (['silver', 'bac', 'bß║íc'].includes(input)) return 'silver';
  if (['gold', 'vang', 'v├áng'].includes(input)) return 'gold';
  if (['diamond', 'kimcuong', 'kim-cuong', 'kim c╞░╞íng'].includes(input)) return 'diamond';
  return 'silver';
}

function isCurrencyToken(value) {
  const input = String(value ?? '').trim().toLowerCase();
  return ['silver', 'bac', 'bß║íc', 'gold', 'vang', 'v├áng', 'diamond', 'kimcuong', 'kim-cuong', 'kim c╞░╞íng'].includes(input);
}
...
function renderCommandResponse(template, { client, context, config, args }) {
  ...
  const riotKeyStatus = riotKey ? 'Γ£à ─É├ú cß║Ñu h├¼nh' : 'Γ¥î Ch╞░a cß║Ñu h├¼nh';
  const tftKeyStatus = tftKey ? 'Γ£à Ri├¬ng' : (riotKey ? 'ΓÖ╗∩╕Å D├╣ng chung LoL key' : 'Γ¥î Ch╞░a cß║Ñu h├¼nh');
  return template
...
function buildSlashOptions(command) {
  if (command.type === 'help') {
    return [
      {
        name: 'group',
        description: 'Chß╗ìn nh├│m c├óu lß╗çnh cß║ºn trß╗ú gi├║p',
        type: ApplicationCommandOptionType.String,
        required: false,
        choices: [
          { name: 'ΓÜÖ∩╕Å Lß╗çnh Chung & Custom', value: 'general' },
          { name: '≡ƒæñ Th├ánh Vi├¬n & Cß║Ñp ─Éß╗Ö', value: 'user' },
          { name: '≡ƒûÑ∩╕Å M├íy Chß╗º & Ph├ít Thanh', value: 'server' },
          { name: '≡ƒ¢í∩╕Å Kiß╗âm Duyß╗çt & Bß║úo Mß║¡t', value: 'moderation' },
          { name: '≡ƒöö T╞░╞íng T├íc & N├║t Bß║Ñm', value: 'interactions' },
          { name: 'ΓÜö∩╕Å League of Legends & TFT', value: 'lol' },
        ]
      }
    ];
  }
    ...
    return [
      {
        ...
        required: false,
        choices: [
          { name: 'Bß║íc', value: 'silver' },
          { name: 'V├áng', value: 'gold' },
          { name: 'Kim c╞░╞íng', value: 'diamond' }
        ]
      }
    ];
  }
  ...
  // ΓöÇΓöÇ League of Legends ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Teamfight Tactics ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
async function runBuiltInCommand({ client, config, command, source, args }) {
  ...
  if (command.type === 'help') {
    ...
    if (isInteraction) {
      ...
      if (['chung', 'general', 'custom', 'lß╗çnh chung'].includes(lowerArgs)) {
        selectedGroup = 'general';
      } else if (['th├ánh vi├¬n', 'user', 'member', 'levels', 'xp', 'rank', 'cß║Ñp ─æß╗Ö'].includes(lowerArgs)) {
        selectedGroup = 'user';
      } else if (['m├íy chß╗º', 'server', 'broadcast', 'ph├ít thanh', 'announcement'].includes(lowerArgs)) {
        selectedGroup = 'server';
      } else if (['kiß╗âm duyß╗çt', 'moderation', 'mod', 'security', 'bß║úo mß║¡t'].includes(lowerArgs)) {
        selectedGroup = 'moderation';
      } else if (['t╞░╞íng t├íc', 'interactions', 'role', 'ticket', 'n├║t bß║Ñm'].includes(lowerArgs)) {
        selectedGroup = 'interactions';
      } else if (['lol', 'league', 'li├¬n minh', 'lsd', 't╞░ß╗¢ng', 'tft', 'teamfight', 'tactics', 'tftlsd', '─æß║Ñu tr╞░ß╗¥ng'].includes(lowerArgs)) {
        selectedGroup = 'lol';
      }
    }
...
export function createBot(configStore, stateStore) {
  ...
  client.once(Events.ClientReady, (readyClient) => {
    ...
    (async () => {
      ...
      // 3. Sync slash commands for every guild ΓÇö await each one so errors surface clearly
      ...
      for (const guild of guilds) {
        try {
          ...
          console.log(`[bot] Γ£à Synced ${result.count} commands ΓåÆ ${guild.name} (${guild.id})`);
          synced += 1;
        } catch (error) {
          console.error(`[bot] Γ¥î Failed to sync commands for ${guild.name} (${guild.id}): ${error.message}`);
        }
      }
  ...
  // ΓöÇΓöÇ Resilience: log disconnects and errors instead of silently dying ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  client.on(Events.ShardDisconnect, (event, shardId) => {
    console.warn(`[bot] Shard ${shardId} disconnected (code ${event.code}). Discord.js will auto-reconnect.`);
  });

  client.on(Events.ShardReconnecting, (shardId) => {
    console.log(`[bot] Shard ${shardId} reconnectingΓÇª`);
  });
  ...
  client.on(Events.ShardError, (error, shardId) => {
    ...
    // Do NOT re-throw ΓÇö discord.js handles its own reconnect logic.
  });
      ...
      if (interaction.customId.startsWith('help_select:')) {
        ...
        if (interaction.user.id !== targetUserId) {
          await interaction.reply({
            content: 'Γ¥î Chß╗ë ng╞░ß╗¥i sß╗¡ dß╗Ñng lß╗çnh ban ─æß║ºu mß╗¢i c├│ thß╗â t╞░╞íng t├íc vß╗¢i menu n├áy!',
            ephemeral: true
          });
          return;
        }
  ...
  // ΓöÇΓöÇ Self-ping keepalive ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  // Thay thß║┐ UptimeRobot: bot tß╗▒ gß╗¡i tin nhß║»n v├áo channel keepalive mß╗ùi 14 ph├║t
  // ─æß╗â Render kh├┤ng spin down process. Channel ID set qua env KEEPALIVE_CHANNEL_ID.
  // Nß║┐u kh├┤ng c├│ channel ID, chß╗ë log heartbeat ─æß╗â giß╗» event loop active.
  (function startKeepalive() {
    const INTERVAL_MS = 14 * 60 * 1000; // 14 ph├║t ΓÇö Render spin down sau 15 ph├║t

    setInterval(async () => {
      const channelId = process.env.KEEPALIVE_CHANNEL_ID;
      if (!channelId) {
        // Kh├┤ng c├│ channel ΓåÆ chß╗ë log ─æß╗â event loop kh├┤ng idle
        console.log(`[keepalive] heartbeat ΓÇö uptime ${Math.floor(process.uptime())}s, ws.ping ${client.ws.ping}ms`);
        return;
      }
      try {
        const ch = await client.channels.fetch(channelId).catch(() => null);
        if (!ch?.isTextBased()) return;
        // Gß╗¡i tin nhß║»n invisible (zero-width space) ─æß╗â kh├┤ng spam visible
