...
function buildSlashOptions(command) {
    ...
    return [
      {
        ...
        required: false,
        choices: [
          { name: '⚙️ Hệ Thống Bot & Cơ Bản', value: 'core' },
          { name: '🛠️ Tiện Ích & Nhắc Nhở', value: 'utility' },
          ...
          { name: '🤖 Trợ Lý Trí Tuệ AI', value: 'ai' },
        ]
      }
    ];
  }
  ...
  if (command.type === 'setup' || command.name === 'setup') {
    return [
      {
        name: 'default',
        description: 'Tạo kênh Join to Create mặc định',
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          {
            name: 'category',
            description: 'Chọn Category có sẵn để đặt kênh Join to Create',
      ...
      {
        name: 'reset',
        description: 'Xóa cấu hình VoiceMaster và kênh Master',
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          {
            name: 'confirm',
            description: 'Xác nhận xóa (Mặc định: True)',
            type: ApplicationCommandOptionType.Boolean,
            required: false
          }
        ]
