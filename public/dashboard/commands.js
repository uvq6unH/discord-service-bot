...
const commandGroupMeta = {
  general: { title: 'Lệnh chung', hint: 'Ping, help, config và custom command', icon: 'ti ti-terminal-2', tone: 'blue' },
  user: { title: 'Người dùng & XP', hint: 'Thông tin người dùng, rank, daily và economy', icon: 'ti ti-award', tone: 'green' },
  server: { title: 'Máy chủ & Thông báo', hint: 'Lệnh server, purge, say và announce', icon: 'ti ti-speakerphone', tone: 'amber' },
  moderation: { title: 'Moderation & AutoMod', hint: 'Warn, kick, ban, timeout và kiểm duyệt', icon: 'ti ti-shield-check', tone: 'red' },
  interactions: { title: 'Ticket & Roles', hint: 'Ticket panel và role panel', icon: 'ti ti-ticket', tone: 'teal' },
  games: { title: '🎮 Trò Chơi', hint: 'Blackjack, Poker, Coinflip, Dice, Slots', icon: 'ti ti-cards', tone: 'purple' },
  lol: { title: '⚔️ LoL & TFT', hint: 'Lịch sử đấu, hồ sơ, tướng, trang bị · TFT history', icon: 'ti ti-sword', tone: 'orange' },
};
